...
namespace Engine
{
	namespace Math
	{
		...
		public:
			...
			//inline Vector2(float i_x, float i_y); Constructors shouldn't be inlined
			// copy constructor - for completeness
			Vector2(const Vector2& i_other);
			//inline Vector2(const Vector2& i_other); Constructors shouldn't be inlined
			// assignment operator
			...
			//inline void z(float i_z); why is there a z float in a Vector2
